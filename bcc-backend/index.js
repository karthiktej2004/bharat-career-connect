...
const pool = new Pool({
    // Replace the string below with your actual Render External Database URL
    ...
    ssl: {
        rejectUnauthorized: false // This is strictly required by Render to allow the connection
    }
});
