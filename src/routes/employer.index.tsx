      ...
      {employerUser && (
        <Card className="p-4 border-border/60 mb-6 flex items-center gap-4 flex-wrap">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-bold text-navy">{employerUser.name || employerUser.companyName || "Employer"}</span>
            <Badge className="bg-india-green/15 text-india-green">Verified employer</Badge>
          </div>
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <IdCard className="h-4 w-4" />
            Employer ID: <span className="font-mono text-navy">EMP-{employerUser.id}</span>
          </div>
          <div className="text-sm text-muted-foreground">Contact: <b className="text-navy">{employerUser.email}</b></div>
        </Card>
      )}
